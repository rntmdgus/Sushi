...
function draw() {
	...
	//아래스시1
	image(earth,1000 + Math.cos(timing1*2*PI)*2250-400,200 + Math.sin(timing1*2*PI)*750-400,800,800);

	//아래스시1
	image(earth,1000 + Math.cos(timing2*2*PI)*2250-400,200 + Math.sin(timing2*2*PI)*750-400,800,800);
